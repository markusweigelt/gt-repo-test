...
<div class="metadata">
   ...
   <ul>
      <li>
         <a href="https://github.com/markusweigelt/gt-repo-test/releases/tag/v0.0.5">The BagIt 'ocrd.zip' files for the current version, please download them from the latest release.: Release 6_v0.0.5</a>
      </li>
      <li>
